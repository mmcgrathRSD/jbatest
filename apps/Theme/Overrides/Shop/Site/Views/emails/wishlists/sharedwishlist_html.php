...
.border{background-color:#c8c8c8}.image-frame{background-color:#dadada}.image-background{background-color:#f7f7f7}
    ...
    <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #fbfbfb">
        ...
        <tbody><tr>
          <td style="padding: 0;vertical-align: top">
            <table style="border-collapse: collapse;border-spacing: 0;width: 602px">
              <tbody><tr>
                <td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: sans-serif"><?php echo $user['first_name'].' '.$user['last_name'] ; ?> has shared a Wishlist with you.</td>
      ...
      <table class="header centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 602px">
        ...
        <tr><td class="logo" style="padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least"><div class="logo-center" style="font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif;text-align: center" align="center" id="emb-email-header"><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 600px" src="<?php echo $base;?>theme/img/email-header.png" alt="" width="600" height="75" /></div></td></tr>
      </tbody></table>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: Tahoma,sans-serif;line-height: 44px"><?php echo $user['first_name']. " " .$user['last_name']; ?> has shared a Wishlist with you.</h1>
            ...
            <div class="btn" style="Margin-bottom: 24px;padding: 2px;text-align: center">
              <![if !mso]><a style="border: 1px solid #ffffff;display: inline-block;font-size: 13px;font-weight: bold;line-height: 15px;outline-style: solid;outline-width: 2px;padding: 10px 30px;text-align: center;text-decoration: none !important;transition: all .2s;color: #fff !important;font-family: sans-serif;background-color: #0e63bb;outline-color: #0e63bb;text-shadow: 0 1px 0 #0d59a8" href="<?php echo $link; ?>">View Wishlist</a><![endif]>
            <!--[if mso]><v:rect xmlns:v="urn:schemas-microsoft-com:vml" href="<?php echo $link; ?>" style="width:154px" fillcolor="#0E63BB" strokecolor="#0E63BB" strokeweight="6px"><v:stroke linestyle="thinthin"></v:stroke><v:textbox style="mso-fit-shape-to-text:t" inset="0px,7px,0px,7px"><center style="font-size:13px;line-height:15px;color:#FFFFFF;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:0px">View Wishlist</center></v:textbox></v:rect><![endif]--></div>
