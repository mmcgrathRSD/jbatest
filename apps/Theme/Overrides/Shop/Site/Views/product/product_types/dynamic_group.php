            ...
            <div class="product-essential">
               <!-- <form action="https://www.subispeed.com/checkout/cart/add/uenc/aHR0cHM6Ly93d3cuc3ViaXNwZWVkLmNvbS9zdWJhcnUtbWF0dGUtYmxhY2stYWMta25vYi1mdWxsLXJlcGxhY2VtZW50LTIwMTUtd3J4LXN0aS0yMDE0LWZvcmVzdGVyLTIwMTMtY3Jvc3N0cmVr/product/13193/form_key/PTT3lpSgzitk4OCG/" method="post" id="product_addtocart_form">
                  ...
                  <div class="product-shop ">
                     ...
                     <meta itemprop="image" content="<?php echo $item->getFeaturedImage(); ?>">
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6 pull-right col-sm-12 col-xs-12 dynLockup sticky_parent">
                        <form action="/shop/cart/add" method="post" class="addToCartForm" <?php if(\Dsc\ArrayHelper::get($item->policies, 'requires_assembly')) : ?>data-assembled="1"<?php endif; ?>>
                           ...
                           <?php echo $this->renderView ('Shop/Site/Views::product/blocks/lockup/add_to_cart.php'); ?> 
                        </form>
                     </div>
                  ...
                  <fieldset class="">
                     ...
                     <table class="data-table" id="product-review-table">
                        ...
                        <col width="100%">
                                 ...
                                 <th>Ease of Installation</th>
                                    ...
                                    <input type="radio" name="ease_of_installation" id="EaseofInstallation_1" value="16" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="EaseofInstallation_2" data-index="2"></span>
                                    <input type="radio" name="ease_of_installation" id="EaseofInstallation_2" value="17" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="EaseofInstallation_3" data-index="3"></span>
                                    <input type="radio" name="ease_of_installation" id="EaseofInstallation_3" value="18" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="EaseofInstallation_4" data-index="4"></span>
                                    <input type="radio" name="ease_of_installation" id="EaseofInstallation_4" value="19" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="EaseofInstallation_5" data-index="5"></span>
                                    <input type="radio" name="ease_of_installation" id="EaseofInstallation_5" value="20" class="radio">
                                 </td>
                                 ...
                                 <th>Fit / Quality</th>
                                    ...
                                    <input type="radio" name="fit_and_quality" id="FitQuality_1" value="21" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="FitQuality_2" data-index="2"></span>
                                    <input type="radio" name="fit_and_quality" id="FitQuality_2" value="22" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="FitQuality_3" data-index="3"></span>
                                    <input type="radio" name="fit_and_quality" id="FitQuality_3" value="23" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="FitQuality_4" data-index="4"></span>
                                    <input type="radio" name="fit_and_quality" id="FitQuality_4" value="24" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="FitQuality_5" data-index="5"></span>
                                    <input type="radio" name="fit_and_quality" id="FitQuality_5" value="25" class="radio">
                                 </td>
                                                         <td class="selected-value" data-index="0">0 out of 5</td>
                              </tr>
                                                <tr>
                                 <th>Overall Satisfaction</th>
                                    ...
                                    <input type="radio" name="overall_satisfaction" id="OverallSatisfaction_1" value="11" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="OverallSatisfaction_2" data-index="2"></span>
                                    <input type="radio" name="overall_satisfaction" id="OverallSatisfaction_2" value="12" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="OverallSatisfaction_3" data-index="3"></span>
                                    <input type="radio" name="overall_satisfaction" id="OverallSatisfaction_3" value="13" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="OverallSatisfaction_4" data-index="4"></span>
                                    <input type="radio" name="overall_satisfaction" id="OverallSatisfaction_4" value="14" class="radio">
                                 </td>
                                                         <td class="value">
                                    <span class="rating-radio" data-id="OverallSatisfaction_5" data-index="5"></span>
                                    <input type="radio" name="overall_satisfaction" id="OverallSatisfaction_5" value="15" class="radio">
                                 </td>
                                                         <td class="selected-value" data-index="0">0 out of 5</td>
                              </tr>
                                             </tbody>
                     ...
                     <input type="hidden" name="validate_rating" class="validate-rating" value="">
                        ...
                        <li>
                              ...
                              <div class="input-box">
                                 <input type="text" name="__screenname" id="nickname_field" class="input-text required-entry" value="Austin">
                              </div>
                        </li>
                        <li>
