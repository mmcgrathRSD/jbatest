<?php 
namespace JBAShop\Modules\ListrakHorizontalJBA;
...
class Module extends \Modules\Abstracts\Module 
{
    ...
    public function html()
    {
        ...
        \Dsc\System::instance()->get('theme')->registerViewPath( __dir__ . '/Views/', 'JBAShop/Modules/ListrakHorizontalJBA/Views' );
        $string = \Dsc\System::instance()->get('theme')->renderLayout('JBAShop/Modules/ListrakHorizontalJBA/Views::default.php');
