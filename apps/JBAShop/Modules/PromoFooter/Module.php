...
class Module extends \Modules\Abstracts\Module 
{
    ...
    public function html()
    {
        ...
        \Dsc\System::instance()->get('theme')->registerViewPath( __dir__ . '/Views/', 'RallyShop/Modules/PromoFooter/Views' );
        $string = \Dsc\System::instance()->get('theme')->renderLayout('RallyShop/Modules/PromoFooter/Views::default.php');
