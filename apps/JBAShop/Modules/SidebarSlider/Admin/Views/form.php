...
<?php $i=1; foreach($options as $option){ ?>
    <div class="hero-slide">
        ...
        <div class="hero-slide-inner">
            ...
            <div class="col-sm-12">
                <label>Link</label>
                <input type="text" class="form-control" name="Hero_Slides[slide<?php echo $i; ?>][link][href]" value="<?php if(isset($item->get('Hero_Options')['link']['href'])) { echo $item->get('Hero_Options')['link']['href']; }?>">
            </div>
            <div class="col-sm-12">
                <label>Link Text</label>
                <input type="text" class="form-control" name="Hero_Slides[slide<?php echo $i; ?>][link][text]" value="<?php if(isset($item->get('Hero_Options')['link']['text'])) { echo $item->get('Hero_Options')['link']['text']; }?>">
            </div>
        </div>
