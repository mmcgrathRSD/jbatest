<?php 
namespace RallyShop\Modules\HomepageProducts;
...
class Module extends \Modules\Abstracts\Module 
{
    ...
    public function html()
    {
        ...
        \Dsc\System::instance()->get('theme')->registerViewPath( __dir__ . '/Views/', 'RallyShop/Modules/ManufacturerProductRebate/Views' );
        $string = \Dsc\System::instance()->get('theme')->renderLayout('RallyShop/Modules/ManufacturerProductRebate/Views::default.php');
