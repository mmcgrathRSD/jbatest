...
class Module extends \Modules\Abstracts\Module 
{
    ...
    public function html()
    {
        ...
        \Dsc\System::instance()->get('theme')->registerViewPath( __dir__ . '/Views/', 'JBAShop/Modules/ManufacturerProductRebate/Views' );
        $string = \Dsc\System::instance()->get('theme')->renderLayout('JBAShop/Modules/ManufacturerProductRebate/Views::default.php');
