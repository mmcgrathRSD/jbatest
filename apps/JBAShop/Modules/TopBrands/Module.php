...
class Module extends \Modules\Abstracts\Module 
{
    ...
    public function html()
    {
        ...
        \Dsc\System::instance()->get('theme')->registerViewPath( __dir__ . '/Views/', 'JBAShop/Modules/TopBrands/Views' );
        $string = \Dsc\System::instance()->get('theme')->renderLayout('JBAShop/Modules/TopBrands/Views::default.php');
