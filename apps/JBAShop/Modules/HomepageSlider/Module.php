<?php 
namespace JBAShop\Modules\HomepageSlider;
...
class Module extends \Modules\Abstracts\Module 
{
    ...
    public function html()
    {
        ...
        \Dsc\System::instance()->get('theme')->registerViewPath( __dir__ . '/Views/', 'JBAShop/Modules/HomepageSlider/Views' );
        $string = \Dsc\System::instance()->get('theme')->renderLayout('JBAShop/Modules/HomepageSlider/Views::default.php');
