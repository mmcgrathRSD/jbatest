<?php 
namespace JBAShop\Modules\HomepageMidSlider;
...
class Module extends \Modules\Abstracts\Module 
{
    ...
    public function html()
    {
        ...
        \Dsc\System::instance()->get('theme')->registerViewPath( __dir__ . '/Views/', 'JBAShop/Modules/HomepageMidSlider/Views' );
        $string = \Dsc\System::instance()->get('theme')->renderLayout('JBAShop/Modules/HomepageMidSlider/Views::default.php');
