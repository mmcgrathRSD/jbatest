<!-- icheck -->
<script src="./AdminTheme/js/plugin/icheck/jquery.icheck.js"></script>

<!-- datepicker -->
<script src="./AdminTheme/js/plugin/datepicker/bootstrap-datepicker.js"></script>
<link rel="stylesheet" href="./AdminTheme/js/plugin/datepicker/datepicker.css" type="text/css" />
