    ...
    <nav class="primary-nav">
        ...
        foreach ($list as $key => $item) 
        {
            ...
            $selected = ($current == $item->route) 
                        ...
                        || (\Dsc\StringHelper::inStrings(\Dsc\ArrayHelper::getColumn($item->getDescendants(), 'route'), $current ))
                        ;
        ...
        <?php if(class_exists('\DealerPortal\Admin\Listener')) : ?>
            <li data-depth="2" class="menu-item dropdown">
                <a href="javascript:void(0);">
                    <i class="fa fa-lg fa-fw fa fa-tasks"></i>
                    <span class="menu-item-parent">Wholesale</span>
                </a>
            </li>
        <?php endif; ?>
