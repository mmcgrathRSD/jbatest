                    ...
                    jQuery(document).ready(function() {
                        ...
                        jQuery("#filter_user").select2({
                            ...
                            , initSelection : function (element, callback) {
                                var data = <?php echo json_encode( \Shop\Models\Customers::forSelection( array('_id'=>new \MongoDB\BSON\ObjectID( $state->get('filter.user') ) ) ) ); ?>;
                                callback(data);            
                            }
                            <?php } ?>                        
                        });
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8">
                            <legend>
                                ...
                                <?php if(!empty($order->existsingp)) :?>
                            	  <button class="btn btn-success pull-right">Exists in GP</button>
                            	<br clear="both">
                            	<?php endif;?>
                                <a class="btn btn-default pull-right" href="/admin/shop/order/generatexml/<?php echo $order->id; ?>">Regenerate eConnect File</a>
