...
jQuery(document).ready(function() {
    ...
    jQuery("#reward_groups").select2({
        ...
        , initSelection : function (element, callback) {
            var data = <?php echo json_encode( \Users\Models\Groups::forSelection( array('_id'=>array('$in'=>array_map( function($input){ return new \MongoDB\BSON\ObjectID($input); }, (array) $flash->old('reward_groups') ) ) ) ) ); ?>;
            callback(data);            
        }
        <?php } ?>
    });
