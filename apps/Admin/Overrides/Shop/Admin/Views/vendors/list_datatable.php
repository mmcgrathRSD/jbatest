            ...
            <div class="col-xs-12 col-sm-5 col-md-3 col-lg-3">
                ...
                <div class="input-group">
                    <select id="bulk-actions" name="bulk_action" class="form-control">
                        ...
                        <option value="delete" data-action="./admin/shop/vendors/delete">Delete</option>
                    </select>
                    <span class="input-group-btn">
    ...
    <table class="table table-striped table-bordered table-hover table-highlight table-checkable">
        ...
        <?php if (!empty($paginated->items)) { ?>
            ...
            <tr>
                ...
                <td class="">
                    <a href="./admin/shop/vendor/edit/<?php echo $item->_id; ?>">
                ...
                <td class="">
                    <a href="./admin/shop/vendor/edit/<?php echo $item->_id; ?>">
                   <?php echo $item->vendor_number; ?>
                    </a>
                </td>
                                
                <td class="text-center">
                    <a class="btn btn-xs btn-secondary" href="./admin/shop/vendor/edit/<?php echo $item->_id; ?>">
                        <i class="fa fa-pencil"></i>
                    </a>
                    &nbsp;
                    <a class="btn btn-xs btn-danger" data-bootbox="confirm" href="./admin/shop/vendor/delete/<?php echo $item->_id; ?>">
