<div class="row">
	...
	<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
         <li>
                <a target="_blank" class="btn btn-danger" href="./admin/user/edit/<?php echo $item->id; ?>">Edit User Details</a>
            </li>
            <li>
...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="panel panel-default">
         ...
         <div class="panel panel-default">
            <div class="panel-heading">Price Level</div>
            <div class="panel-body">
               <?php 
               switch ($item->{'shop.pricelevel'}) {
               	case 'retail':
               		echo 'RETAIL';
               	break;
               	case 'wholesale_d1':
