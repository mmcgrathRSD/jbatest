...
jQuery(document).ready(function() {
    ...
    jQuery("#products").select2({
        ...
        , initSelection : function (element, callback) {
            var data = <?php echo json_encode( \Shop\Models\Products::forSelection( array('_id'=>array('$in'=>array_map( function($input){ return new \MongoDB\BSON\ObjectID($input); }, (array) \Shop\Models\Tags::productIds( $flash->old('title') ) ) ) ) ) ); ?>;
            callback(data);            
        }
        <?php } ?>
    });
